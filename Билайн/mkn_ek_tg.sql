...
truncate table mkn_ek_tg;
insert into  mkn_ek_tg
select t1.*
from(select t1.time_key,t1.market_key,subs_key,ban_key from MKN_PA_EK t1
...
where ek_ind=1 and SALES_IND_1M=0 and segment_key like 'B2C' and time_key=date'2021-11-01'
